...
export const Basic: Story = {
  args: {
    ...
    currentThumbStyle: "bg-muted border-primary border-primary border-[1px]",
...
export const WithoutSteps: Story = {
  args: {
    ...
    currentStep: 2,
    activeThumbStyle: "bg-primary",
    inactiveThumbStyle: "bg-accent border-gray-300",
    currentThumbStyle: "bg-muted border-primary border-1",
    activeThumbLabelStyle: "text-white font-semibold",
    progressbarActiveStyle: "h-[1px]",
  },
};
