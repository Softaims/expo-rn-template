...
export function ArrowLeftIcon({ width = 8, height = 16, color, fill = "#000" }: IconProps) {
  const fillColor = fill || color || "#000";

  return (
    <Svg width={width} height={height} viewBox="0 0 8 16" fill="none">
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
